...
#  - (Y) Test interpolation in ConfigDefault entries
#  - (Y) Error message makes the wrong suggestions when the override is in a nested default.

# TODO Documentation
#  - (Y) Create Defaults List
#  - (Y) Create a page for packages overrides
#  - (Y) Create a page for Extending configs
#  - (Y) Create a page describing configuring experiments with Hydra (experiment use case)
#  - (Y) Create https://hydra.cc/docs/next/upgrades/1.0_to_1.1/defaults_list_override
#  - (Y) Create https://hydra.cc/docs/next/upgrades/1.0_to_1.1/default_composition_order
#  - (Y) Document --info defaults and --info defaults-tree
#  - (Y) Update command line flags page
